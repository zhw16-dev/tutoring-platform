...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Students can filter by subject and grade, see ratings and bios, and book directly. Functions like a marketplace.',
    position: 'bottom',
  ...
  },
  {
    ...
    body: 'Clicking here opens a booking modal, where you can select a subject, pick a date and time, add notes. The session is instantly scheduled.',
    position: 'left',
    autoAction: { tab: 'browse' },
  },
  {
    ...
    body: 'All upcoming and past sessions in one place. Students can cancel anytime with no need to text or email.',
    position: 'bottom',
  ...
  // Tutor Tour (4 steps)
  {
    ...
    body: 'Tutors see everything they need at a glance: upcoming sessions, completed count this month, total earnings, and pending payout.',
    position: 'bottom',
  ...
  },
  {
    ...
    body: 'After each session, tutors mark it as completed or no-show. This updates the payment flow automatically with no manual invoicing.',
    position: 'bottom',
    autoAction: { tab: 'sessions' },
  },
  {
  ...
  },
  {
    ...
    body: "The admin view is what transformed my weekly operations. Let\u2019s take a look.",
    position: 'bottom',
  },
  ...
  // Admin Tour (5 steps)
  {
    ...
    body: 'The topline health of the business is shown in four numbers: sessions this month, monthly revenue, active tutors, and outstanding payments.',
    position: 'bottom',
  ...
  },
  {
    ...
    body: 'Unlogged sessions, overdue payments, and recent no-shows surface automatically, meaning I no longer have to check spreadsheets row by row.',
    position: 'bottom',
  ...
  },
  {
    ...
    body: 'Manually reconciling payouts used to be a major hassle. Now I can see exactly who owes what, for which session, and mark it paid with one click.',
    position: 'bottom',
