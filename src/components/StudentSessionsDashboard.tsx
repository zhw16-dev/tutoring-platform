        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-yellow-900">${unpaidAmount}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {unpaidAmount > 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-yellow-800 font-medium">Payment Due: ${unpaidAmount}</h3>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-yellow-50 rounded-lg p-4">
            <div className="text-2xl font-bold text-yellow-900">${unpaidAmount}</div>
            <div className="text-yellow-700 text-sm">Amount Due</div>
          </div>
        </div>
